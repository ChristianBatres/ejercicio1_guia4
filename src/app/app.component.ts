...
export class AppComponent {
 ...
 alumnoArray: Alumno[] = [
  {id:1, name:"Alex", lastname:"Campos",age:35, direccion:"San Salvador", telefono:78596359, mail:"alex@gmailcom"},
  {id:2, name:"Maria",lastname:"Lopez",age:20, direccion:"San Miguel", telefono:78596359, mail:"maria@gmailcom"},
 {id:3, name:"Juan", lastname:"Castro",age:25, direccion:"Santa Ana", telefono:78596359, mail:"juan@gmailcom"}
 ]
...
//de lo contrario limpia el atributo selectedAlumno en pantalla. [(ngModel)]
 addOrEdit(): void
 {
   if (this.selectedAlumno.name !== '' && this.selectedAlumno.lastname !== '' && this.selectedAlumno.age !== 0 && this.selectedAlumno.direccion !== '' && this.selectedAlumno.telefono !== 0 && this.selectedAlumno.mail !== '') {
